            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="text-dark fs-5">
                        <strong>Bookly</strong> tự hào là một trong những nhà cung cấp văn phòng phẩm hàng đầu, mang đến
                        những sản phẩm chất lượng cao, giá cả phải chăng và dịch vụ vượt trội.
                        Với sứ mệnh không chỉ đáp ứng mà còn vượt qua mong đợi của khách hàng, chúng tôi nỗ lực mang lại sự
                        tiện lợi và trải nghiệm mua sắm tốt nhất.
                    </p>
                    <p class="text-dark fs-5">
                        Chúng tôi tin rằng những công cụ học tập và làm việc phù hợp sẽ giúp bạn đạt được những thành công
                        lớn lao. Bookly chính là cầu nối, giúp bạn tiến gần hơn đến những mục tiêu của mình.
                    </p>
                </div>
                <div class="col-lg-6">
                    <img src="{{ asset('assets/client/images/category1.jpg') }}" alt="Về Bookly"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 posts mb-4">
                    ...
                    <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">10 Cuốn Sách Phải Đọc Trong
                            Năm: Lựa Chọn Hàng Đầu Của Chúng Tôi!</a></h4>
                    <p class="mb-2">Khám phá thế giới công nghệ tiên tiến với bài viết blog mới nhất của chúng tôi, nơi
                        chúng tôi giới thiệu năm thiết bị công nghệ thiết yếu... <span><a
                                class="text-decoration-underline text-black-50" href="index.html">Đọc thêm</a></span>
                    </p>
                </div>
                <div class="col-md-3 posts mb-4">
                    <img src="{{ asset('assets/client/images/post-item2.jpg') }}" alt="post image"
                        class="img-fluid rounded-3">
                    <a href="blog.html" class="fs-6 text-primary">Sách</a>
                    <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">Vùng Đất Hấp Dẫn Của Khoa
                            Học Viễn Tưởng</a></h4>
                    <p class="mb-2">Khám phá sự giao thoa giữa công nghệ và phát triển bền vững trong bài viết blog mới
                        nhất của chúng tôi. Tìm hiểu về những đổi mới... <span><a
                                class="text-decoration-underline text-black-50" href="index.html">Đọc thêm</a></span> </p>
                </div>
                <div class="col-md-3 posts mb-4">
                    <img src="{{ asset('assets/client/images/post-item3.jpg') }}" alt="post image"
                        class="img-fluid rounded-3">
                    <a href="blog.html" class="fs-6 text-primary">Sách</a>
                    <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">Tìm kiếm tình yêu qua từng
                            trang sách</a></h4>
                    <p class="mb-2">Đi trước xu thế với cái nhìn sâu sắc của chúng tôi về sự phát triển nhanh chóng của
                        công nghệ ... <span><a class="text-decoration-underline text-black-50" href="index.html">Đọc
                                thêm</a></span>
                    </p>
                </div>
                <div class="col-md-3 posts mb-4">
                    <img src="{{ asset('assets/client/images/post-item4.jpg') }}" alt="post image"
                        class="img-fluid rounded-3">
                    <a href="blog.html" class="fs-6 text-primary">Sách</a>
                    <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">Đọc sách cho sức khỏe tinh
                            thần: Làm thế nào sách có thể chữa lành và truyền cảm hứng</a></h4>
                    <p class="mb-2">Trong môi trường làm việc từ xa ngày nay, năng suất là yếu tố quan trọng. Khám phá
                        các ứng dụng và công cụ hàng đầu giúp bạn duy trì hiệu quả công việc... <span><a
                                class="text-decoration-underline text-black-50" href="index.html">Đọc thêm</a></span>
                    </p>
                </div>
            </div>
