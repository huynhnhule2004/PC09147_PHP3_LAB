    ...
    <div class="container mt-5">
        <div class="row" style="padding-bottom: 7em;">
            <div class="offset-md-1 col-md-3">
                ...
                <img src="{{ asset('uploads/users/1') }}" alt="" width="100%" class="rounded-3">
            ...
            <div class=" col-md-7">
                <div class="card card-body">
                    <form action="/users/1" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="method" value="PUT" id="">
                        <div class="my-3">
                            <label for="username">Tên đăng nhập*</label>
                            <input type="text" name="username" id="username" class="form-control"
                                placeholder="Nhập tên đăng nhập" value="nhu10" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="email">Email*</label>
                            <input type="email" name="email" id="email" class="form-control"
                                placeholder="Nhập email" value="huynhnhule2004@gmail.com" required>
                        </div>
                        <div class="mb-3">
                            <label for="name">Họ và tên*</label>
                            <input type="name" name="name" id="name" class="form-control"
                                placeholder="Nhập họ và tên" value="nhu" required>
                        </div>
                        <div class="mb-3">
                            <label for="date_of_birth">Ngày sinh*</label>
                            <input type="date" name="date_of_birth" id="date_of_birth" class="form-control"
                                placeholder="Nhập ngày sinh" value="1/1/2002" required>
                        </div>
                        <div class="mb-3">
                            <label for="phone_number">Số điện thoại*</label>
                            <input type="text" name="phone_number" id="phone_number" class="form-control"
                                placeholder="Nhập số điện thoại" value="0364402449" required>
                        </div>
                        <div class="mb-3">
                            <label for="address">Địa chỉ*</label>
                            <input type="text" name="address" id="address" class="form-control"
                                placeholder="Nhập địa chỉ" value="Trà VInh" required>
                        </div>
                        <div class="mb-3">
