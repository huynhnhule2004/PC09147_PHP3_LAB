...
@section('content')
    ...
    <div class="container mb-5" style="margin-top: 100px;">
        <p class="text-dark" style="font-style: italic;">Đăng bởi <strong>nhu10</strong> vào ngày 15/03/2025</p>
        <article style="text-align: justify; margin-bottom: 100px;">
            <h1 class="mb-3 text-capitalize" style="font-size: 3rem">Đắc Nhân Tâm</h1>
            <img src="{{ asset('assets/client/images/post-item1.jpg') }}" alt="" class="img-fluid mb-4 w-50">
                                    ...
                                    <div class="card card-body">
                                        <form action="#" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="editContent" name="content" rows="3" placeholder="Nhập bình luận..."
                                            ...
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <button type="button" class="btn btn-secondary btn-sm"
                                                    id="cancelEditButton" style="padding: 0.5rem 1.25rem;">
                                                    Hủy
                                                </button>
                                            </div>
                                        </form>
                        ...
                        <div class="flex-grow-1">
                            ...
                            <form action="#" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="addContent" name="content" rows="3" placeholder="Nhập bình luận..."
                                        required style="font-size: 18px;"></textarea></textarea>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3 posts mb-4">
                        ...
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="/blogs/1">10 Cuốn Sách Phải Đọc
                                Trong Năm: Lựa Chọn Hàng Đầu Của Chúng Tôi!</a></h4>
                        <p class="mb-2">Khám phá thế giới công nghệ tiên tiến với bài viết blog mới nhất của chúng tôi,
                            nơi chúng tôi giới thiệu năm thiết bị công nghệ thiết yếu... <span><a
                                    class="text-decoration-underline text-black-50" href="/blogs/1">Đọc thêm</a></span>
                        </p>
                    </div>
                    <div class="col-md-3 posts mb-4">
                        <img src="{{ asset('assets/client/images/post-item2.jpg') }}" alt="post image"
                            class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Sách</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="/blogs/1">Vùng Đất Hấp Dẫn Của Khoa
                                Học Viễn Tưởng</a></h4>
                        <p class="mb-2">Khám phá sự giao thoa giữa công nghệ và phát triển bền vững trong bài viết blog
                            mới nhất của chúng tôi. Tìm hiểu về những đổi mới... <span><a
                                    class="text-decoration-underline text-black-50" href="/blogs/1">Đọc thêm</a></span>
                        </p>
                    </div>
                    <div class="col-md-3 posts mb-4">
                        <img src="{{ asset('assets/client/images/post-item3.jpg') }}" alt="post image"
                            class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Sách</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="/blogs/1">Tìm kiếm tình yêu qua
                                từng trang sách</a></h4>
                        <p class="mb-2">Đi trước xu thế với cái nhìn sâu sắc của chúng tôi về sự phát triển nhanh chóng
                            của công nghệ ... <span><a class="text-decoration-underline text-black-50" href="/blogs/1">Đọc
                                    thêm</a></span>
                        </p>
                    </div>
                    <div class="col-md-3 posts mb-4">
                        <img src="{{ asset('assets/client/images/post-item4.jpg') }}" alt="post image"
                            class="img-fluid rounded-3">
                        <a href="blog.html" class="fs-6 text-primary">Sách</a>
                        <h4 class="card-title mb-2 text-capitalize text-dark"><a href="/blogs/1">Đọc sách cho sức khỏe
                                tinh thần: Làm thế nào sách có thể chữa lành và truyền cảm hứng</a></h4>
                        <p class="mb-2">Trong môi trường làm việc từ xa ngày nay, năng suất là yếu tố quan trọng. Khám
                            phá các ứng dụng và công cụ hàng đầu giúp bạn duy trì hiệu quả công việc... <span><a
                                    class="text-decoration-underline text-black-50" href="/blogs/1">Đọc thêm</a></span>
                        </p>
                    </div>
                </div>
