...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6 left-panel">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="fullName" value="Nhu" readonly>
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-md-6 right-panel">
                    ...
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type='hidden' name='price[]' value='139,000 '></td>
                            </tr>

                            <input type='hidden' name='total_price_payment' id='total_price_payment' value='399,000'>";


                            <tr>
                                <td class='text-start fw-bold'>Phí vận chuyển:</td>
                                <td colspan='3'><strong id='shipping_fee'>0 đ</strong></td>
                                <td colspan='3'><input type='hidden' id='shipping_fee_input' name='shipping_fee'
                                        value='0' /></td>
                            </tr>
                            <tr>
                                <td class='text-start fw-bold'>Tổng Cộng:</td>
                                <td colspan='3'><strong id='total_price'>399,000</strong></td>
                                <td colspan='3'><input type='hidden' name='total' value='399,000' /></td>
                                <td colspan='3'><input type='hidden' id='total_order_input' name='total_order'
                                        value='399,000' /></td>
                            </tr>
                    ...
                    <button type="submit" class="btn btn-primary" name="redirect" id="redirect">Xác Nhận Thanh
                        Toán</button>
                </div>
        </form>
    ...
    <script>
        ...
        document.getElementById("phuong").addEventListener("change", async function() {
            ...
            let totalPrice = parseInt(document.getElementById("total_price_payment")
                .value); // Lấy giá trị tổng ban đầu

            if (districtId != "0" && wardCode != "0") {
                const shippingFee = await calculateShipping(districtId, wardCode);
                document.getElementById("shipping_fee").textContent = shippingFee.toLocaleString("vi-VN") +
                    " đ";
        ...
        function updateHiddenAddress() {
            ...
            const fullAddress =
                `${addressDetail} ${tinh !== "Tỉnh Thành" ? tinh : ""} ${quan !== "Quận Huyện" ? quan : ""} ${phuong !== "Phường Xã" ? phuong : ""}`;
