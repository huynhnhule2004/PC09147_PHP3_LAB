...
@section('content')
    <section id="billboard" class="position-relative d-flex align-items-center py-5 bg-light-gray"
        style="background-image: url({{ asset('assets/client/images/banner-image-bg.jpg') }}); background-size: cover; background-repeat: no-repeat; background-position: center; height: 800px;">
                        ...
                        <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="image-holder">
                                    <img src="{{ asset('assets/client/images/banner-image2.png') }}" class="img-fluid"
                                        alt="banner">
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="image-holder">
                                    <img src="{{ asset('assets/client/images/banner-image1.png') }}" class="img-fluid"
                                        alt="banner">
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <div class="row d-flex flex-column-reverse flex-md-row align-items-center">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="image-holder">
                                    <img src="{{ asset('assets/client/images/banner-image.png') }}" class="img-fluid"
                                        alt="banner">
                                </div>
                            </div>
                        </div>
    ...
    <section id="limited-offer" class="padding-large"
        style="background-image: url({{ asset('assets/client/images/banner-image-bg-1.jpg') }}); background-size: cover; background-repeat: no-repeat; background-position: center; height: 800px;">
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6 text-center">
                    <div class="image-holder">
                        <img src="{{ asset('assets/client/images/banner-image3.png') }}" class="img-fluid"
                            alt="banner">
                    </div>
                </div>
                <div class="col-md-5 offset-md-1 mt-5 mt-md-0 text-center text-md-start">
            ...
            <div class="row">
                    ...
                    <div class="featured border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item2.png') }}"
                                ...
                                <div class="item-content ms-3">
                                    ...
                                    <p>Giá giảm: <strong
                                            class="price text-primary fw-bold mb-2 fs-5"><?= number_format(99000) ?>
                                            đ</strong></p>
                                </div>
                            </div>
                            <hr class="gray-400">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item1.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr>
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item3.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="latest-items border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item4.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr class="gray-400">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item5.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr>
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item6.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="best-reviewed border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item7.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr class="gray-400">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item8.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr>
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item9.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                ...
                <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
                    <div class="on-sale border rounded-3 p-4">
                        ...
                        <div class="items-lists">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item10.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr class="gray-400">
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item11.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
                            ...
                            <hr>
                            <div class="item d-flex">
                                <img src="{{ asset('assets/client/images/product-item12.png') }}"
                                    class="img-fluid shadow-sm" alt="product item">
                                <div class="item-content ms-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 border-0 rounded-3 position-relative">
                        <a href="index.html">
                            <img src="{{ asset('assets/client/images/category1.jpg') }}" class="img-fluid rounded-3"
                                alt="cart item">
                ...
                <div class="col-md-4">
                    <div class="card text-center mb-4 border-0 rounded-3">
                        <a href="index.html">
                            <img src="{{ asset('assets/client/images/category2.jpg') }}" class="img-fluid rounded-3"
                                alt="cart item">
                            <h6 class=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a
                ...
                <div class="col-md-4">
                    <div class="card text-center mb-4 border-0 rounded-3">
                        <a href="index.html">
                            <img src="{{ asset('assets/client/images/category3.jpg') }}" class="img-fluid rounded-3"
                                alt="cart item">
                            <h6 class=" position-absolute bottom-0 bg-primary m-4 py-2 px-3 rounded-3"><a
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-3 posts mb-4">
                    ...
                    <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.html">10 Must-Read Books of the
                            Year: Our Top Picks!</a></h4>
