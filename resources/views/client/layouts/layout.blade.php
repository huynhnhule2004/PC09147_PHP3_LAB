...
<body>
    ...
    <div class="search-popup">
        <div class="search-popup-container">
            <form role="search" method="get" class="search-form" action="/search">
                <input type="search" id="search-form" class="search-field" placeholder="Tìm kiếm..."
                    value="" name="keyword" />
    ...
    <header id="header" class="site-header">
        ...
        <div class="top-info border-bottom d-none d-md-block ">
            <div class="container-fluid">
                <div class="row g-0">
                    <div class="col-md-4">
                        <p class="fs-6 my-2 text-center">Cần hỗ trợ? Gọi ngay cho chúng tôi qua số <a
                                href="tel:0364402449" class="text-decoration-underline">0364402449</a></p>
                    </div>
                    <div class="col-md-4 border-start border-end">
                        <p class="fs-6 my-2 text-center">Giảm giá Tết đến 60%! <a class="text-decoration-underline"
                                href="/products">Mua sắm ngay!</a></p>
                    </div>
                    <div class="col-md-4">
                        <p class="fs-6 my-2 text-center">Giao hàng trong 2-3 ngày & miễn phí đổi trả!</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav id="header-nav" class="navbar navbar-expand-lg py-3">
            <div class="container">
                <a class="navbar-brand" href="/">
                    <img src="{{ asset('assets/client/images/main-logo.png') }}" class="logo">
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul id="navbar"
                            ...
                            <li class="nav-item">
                                <a class="nav-link me-4" href="/">Trang chủ</a>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu animate slide border">
                                    ...
                                    <li><a class="dropdown-item" href="/products?category=1">Điện thoại</a></li>
                                    <li><a class="dropdown-item" href="/products?category=2">Laptop</a></li>
                                    <li><a class="dropdown-item" href="/products?category=3">Phụ kiện</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link me-4 " href="/blogs">Bài viết</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <ul class="d-flex justify-content-end list-unstyled mb-0">
                                ...
                                <li class="pe-3 dropdown show" style="display: inline-block;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        ...
                                        <a class="dropdown-item m-0" href="/users/1"
                                            style="font-size: medium;">nhu10</a>
                                        <a class="dropdown-item m-0" href="/users/" style="font-size: medium;"></a>
                                                        ...
                                                        <nav>
                                                            <div class="nav nav-tabs d-flex justify-content-center"
                                                                ...
                                                                <button class="nav-link" id="nav-forgot-password-tab"
                                                                    data-bs-toggle="tab"
                                                                    data-bs-target="#nav-forgot-password"
                                                                    type="button" role="tab"
                                                                    aria-controls="nav-forgot-password"
                                                                    aria-selected="false">
                                                                    Quên mật khẩu?
                                                                </button>
                                                            </div>
                                                        ...
                                                        <div class="tab-content" id="nav-tabContent">
                                                            <div class="tab-pane fade active show" id="nav-sign-in"
                                                                ...
                                                                <form action="/login" class="p-3" method="post">
                                                                    ...
                                                                    <div class="form-group py-3">
                                                                        <label class="mb-2" for="username">Tên đăng
                                                                            nhập*</label>
                                                                    ...
                                                                    <div class="form-group pb-3">
                                                                        <label class="mb-2" for="password">Mật
                                                                            khẩu*</label>
                                                            ...
                                                            <div class="tab-pane fade" id="nav-register"
                                                                ...
                                                                <form action="/register" class="p-3"
                                                                    ...
                                                                    <div class="form-group pb-3">
                                                                        <label class="mb-2" for="sign-in">Mật
                                                                            khẩu*</label>
                                                                    ...
                                                                    <div class="form-group pb-3">
                                                                        <label class="mb-2" for="sign-in">Nhập lại
                                                                            mật khẩu*</label>
                                                                        <input type="password" minlength="2"
                                                                            name="re_password"
                                                            ...
                                                            <div class="tab-pane fade" id="nav-forgot-password"
                                                                role="tabpanel"
                                                                ...
                                                                <div class="form-group py-3">
                                                                    <form action="" class="p-3"
                                                                        ...
                                                                        <a href="/reset-password" name="submit"
                                                                            class="btn btn-dark w-100 my-3">Gửi</a>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <li class="wishlist-dropdown dropdown pe-3">
                                    <a href="/wishlist" {{-- <a href="/wishlist" class="dropdown-toggle" data-bs-toggle="dropdown" role="button" --}} aria-expanded="false">
                                        <svg class="wishlist">
                                    ...
                                    <div
                                        ...
                                        <ul class="list-group mb-3">
                                            <li
                                                ...
                                                <div>
                                                    <h5>
                                                        <a href="/products">Sách Đắc Nhân Tâm</a>
                                                    </h5>
                                                    <!-- <small>Giá ưu đãi đặc biệt.</small> -->
                                                    <a href="#"
                                                        class="d-block fw-medium text-capitalize mt-2">Thêm vào
                                                        giỏ</a>
                                                </div>
                                                <span class="text-primary"><?= number_format(200000) ?> đ</span>
                                            </li>
                                            <li
                                                class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                                                <div>
                                                    <h5>
                                                        <a href="/products">Bút máy</a>
                                                    </h5>
                                                    <!-- <small>Hoàn hảo dành cho những người tinh tế.</small> -->
                                                    <a href="#"
                                                        class="d-block fw-medium text-capitalize mt-2">Thêm vào
                                                        giỏ</a>
                                                </div>
                                                <span class="text-primary"><?= number_format(400000) ?> đ</span>
                                            </li>
                                            <li class="list-group-item bg-transparent d-flex justify-content-between">
                                                <span class="text-capitalize"><b>Tổng cộng (đ)</b></span>
                                                <strong><?= number_format(600000) ?> đ</strong>
                                            </li>
                                        </ul>
                                        <div class="d-flex flex-wrap justify-content-center">
                                            <a href="/cart" class="w-100 btn btn-dark mb-1" type="submit">Thêm tất
                                                cả
                                                vào giỏ</a>
                                            <a href="/cart" class="w-100 btn btn-primary" type="submit">Xem giỏ
                                                hàng</a>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div
                                        ...
                                        <ul class="list-group mb-3">
                                            <li
                                                ...
                                                <div>
                                                    <h5>
                                                        <a href="/products">Đắc Nhân Tâm</a>
                                                    </h5>
                                                    <!-- <small>High quality in good price.</small> -->
                                                </div>
                                                <span class="text-primary"><?= number_format(600000) ?> đ</span>
                                            </li>
                                            <li
                                                class="list-group-item bg-transparent d-flex justify-content-between lh-sm">
                                                <div>
                                            ...
                                            <li class="list-group-item bg-transparent d-flex justify-content-between">
                                                <span class="text-capitalize"><b>Tổng công (đ)</b></span>
                                                <strong><?= number_format(800000) ?> đ</strong>
                                            </li>
                                        </ul>
                                        <div class="d-flex flex-wrap justify-content-center">
                                            <a href="/cart" class="w-100 btn btn-dark mb-1" type="submit">Xem giỏ
                                                hàng</a>
                                            <a href="/cart" class="w-100 btn btn-primary" type="submit">Thanh
                                                toán</a>
                                        </div>
                                    </div>
                                </li>
                    ...
                    <div class="row d-flex flex-wrap justify-content-between">
                        <div class="col-lg-3 col-sm-6 pb-3">
                            <div class="footer-menu">
                                <img src="{{ asset('assets/client/images/main-logo.png') }}" alt="logo"
                                    class="img-fluid mb-2">
                                <p>Chào mừng bạn đến với Bookly! Tại đây chuyên cung cấp các sản phẩm chất lượng cho
                                    công việc và học tập. Mua sắm tiện lợi, giao hàng nhanh chóng!</p>
                        ...
                        <div class="col-lg-3 col-sm-6 pb-3">
                            <div class="footer-menu contact-item">
                                ...
                                <p>Nếu bạn cần hỗ trợ? Gọi ngay cho chúng tôi. <a href="#"
                                        class="text-decoration-underline">0364402449</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ship-and-payment d-flex gap-md-5 flex-wrap">
                    <div class="shipping d-flex">
                        ...
                        <div class="card-wrap ps-2">
                            <img src="{{ asset('assets/client/images/dhl.png') }}" alt="visa">
                            <img src="{{ asset('assets/client/images/shippingcard.png') }}" alt="mastercard">
                        </div>
                    </div>
                    <div class="payment-method d-flex">
                        <p>Các phương thức thanh toán:</p>
                        <div class="card-wrap ps-2">
                            <img src="{{ asset('assets/client/images/visa.jpg') }}" alt="visa">
                            <img src="{{ asset('assets/client/images/mastercard.jpg') }}" alt="mastercard">
                            <img src="{{ asset('assets/client/images/paypal.jpg') }}" alt="paypal">
                        </div>
                    </div>
                </div>
                <div class="copyright">
    ...
    <script lang="javascript">
        var __vnp = {
            code: 23609,
            key: '',
            secret: '9fc00ace2dd2671f429cb46a14ceb0ec'
        };
        (function() {
            ...
            ga.async = true;
            ga.defer = true;
            ga.src = 'https://core.vchat.vn/code/tracking.js?v=95821';
