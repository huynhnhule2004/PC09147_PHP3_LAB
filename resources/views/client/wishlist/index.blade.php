    ...
    <section id="billboard"
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="text-black">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active text-black" aria-current="page">Yêu thích</li>
            </ol>
        </nav>
        ...
        <div id="main-content-wp" class="cart-page">
            ...
            <div id="wrapper" class="wp-inner clearfix">
                                        ...
                                        <div class="clearfix">
                                            <div class="fl-right">
                                                <a href="/checkout" title="" style="float: right;"
                                                    class="btn btn-danger text-white">Thanh toán</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="section" id="action-cart-wp">
                    <div class="section-detail">
                        <a href="/products" title="" id="buy-more">Cửa hàng</a><br />
                        <a href="/cart/clearCart" title="" id="delete-cart">Xóa tất cả</a>
                    </div>
                </div>
